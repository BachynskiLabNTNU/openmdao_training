...
class computeMball(om.ExplicitComponent):
    ...
    def setup_partials(self):
        #TODO Declare remaining partials using your preferred method
    ...
    def compute_partials(self, inputs, partials):
        #TODO Add appropriate definitions of partials here
...
class computeTheta(om.ExplicitComponent): 
    ...
    def setup_partials(self):
        #TODO Declare all partials to be finite differenced
...
class computeLCOE(om.ImplicitComponent):
    ...
    def apply_nonlinear(self, inputs, outputs, residuals):
        ...
        #TODO Write the equation above in residual form to be used in an implicit function
        residuals['LCOE'] = 
    ...
    def linearize(self, inputs, outputs, partials):
        ...
        # Note, you must define partial of x wrt x for implicit components
        partials['LCOE', 'LCOE'] = -1.
        #TODO Properly define remaining partials
...
if __name__ == "__main__":
    ...
    if solver_flag == 'newton':
        ...
        # solve_subsystems should almost always be turned on it improves solver robustness
